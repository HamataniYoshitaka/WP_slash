...
<div class="bg-black w-full h-9">
    <div class="flex h-full">
        ...
        <div class="hidden w-48 h-full border-r-2 border-[#333333] text-white md:flex justify-center items-center">
            <?php echo date('Y/m/d'); ?>
        </div>
        <a href="https://x.com/ai_tech_slash" target="_blank" rel="noopener noreferrer" class="w-11 h-full hover:bg-[#E6675C] hidden md:flex justify-center items-center transition-all duration-500" aria-label="X">
